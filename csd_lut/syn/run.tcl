...
analyze -format verilog {csd_lut.v}
elaborate csd_lut; # top module name

# store the unmapped results
write -hierarchy -format ddc -output results/csd_lut.unmapped.ddc
...
source csd_lut.constraints.tcl
...
check_design > reports/csd_lut.check_design.rpt; # dump to the file
...
# Write out design
write -format verilog -hierarchy -output results/csd_lut.mapped.v
write -format ddc -hierarchy -output results/csd_lut.mapped.ddc
write_sdf results/csd_lut.mapped.sdf
write_sdc -nosplit results/csd_lut.mapped.sdc

# Generate reports
report_qor > reports/csd_lut.mapped.qor.rpt
report_timing -transition_time -nets -attribute -nosplit \
  > reports/csd_lut.mapped.timing.rpt
report_area -nosplit > reports/csd_lut.mapped.area.rpt
report_power -nosplit > reports/csd_lut.mapped.power.rpt
